...
public class CourseController {
    ...
    public ResponseEntity<List<StudentRespons>> getCourseStudents(@PathVariable Long courseId) {
        //TODO
        return ResponseEntity.ok(List.of());
    }

    @PostMapping("/{courseId}/students")
    public ResponseEntity<String> addCourseStudent(@PathVariable Long courseId, @RequestBody List<StudentRequest> students) {
        //TODO
